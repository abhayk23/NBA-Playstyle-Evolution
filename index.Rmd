...
To visually present our findings to the audience, we created time-series graphs to illustrate trends in 3PM and 3PA between Decade 1 and Decade 2 (Figure 2). These graphs highlighted interesting trends in 3PM for the entire league and specifically for Stephen Curry since his draft (Figure 3). Additionally, one graph showcased trends in 3P%, 2P%, and FG% between the two decades (Figure 4), while another visualized the relationship between FT and FTA over the same period (FIgure 5). To conclude our analysis, we generated a line chart that depicted a 1% increase in FT% between the two decades (Figure 6) and a bar chart that illustrated the ANOVA post hoc analysis conducted on Personal Fouls (Figure 1).
...
![](images/PCALoadingsD1-01.png){width="220"}

~PCA Loading - Decade 1, **Table 3**~

![](images/PCALoadingsD2.png){width="220"}

~PCA Loading - Decade 2, **Table 4**~

In Decade 2 (2010-2019), Table 4 indicated that PC1 exhibited loading patterns akin to Decade 1, emphasizing offensive statistics. Similar to Decade 1, PC2 in Table 2 showcased loading on rebounding, defensive stats, and shooting percentages. The cumulative variance of the first three PCs, as presented in Table 5, reached 77.50%, surpassing the threshold of 70%. The cumulative variance of the first three PCs, as shown in Table 6, reached 75.91%, meeting the 70% threshold. Therefore, we chose to use 3 PCs for both decades. These initial interpretations proved to be vital as we were able to use the first two PCs as the x-axis and y-axis for our K-Means scatterplot to plot all of Decade 1 and Decade 2 players along each PC.
...
![](images/Elbow_Plot_Decade1-03.png){width="481"}

![](images/Silhouette_Plot_Decade1-03.png){width="481"}

~Elbow and Silhouette Plots - Decade 1, **Figure 7**~

![](images/Elbow_Plot_Decade2-02.png){width="479"}

![](images/Silhouette_Plot_Decade2-03.png){width="481"}
...
![](images/Cluster_Analysis_Scatter_Plot_Decade1-01.png)
...
To derive meaningful interpretations for each cluster, we calculated the mean for each statistic within each cluster, as presented in Table 7 and Table 8.
